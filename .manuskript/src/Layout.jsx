    ...
    return (
        <React.Fragment>
            ...
            <div className="flex min-h-screen bg-slate-50 text-slate-600">
                <div className="w-80 border-r border-slate-200 bg-slate-100">
                    <div className="sticky top-0">
                        <div className="p-8">
                            <Link className="hover:text-blue-600" href="/manuskript">
                                                ...
                                                <li key={group + label}>
                                                    <Link
                                                        ...
                                                        className={classNames({
                                                            "text-blue-600": currentUrl.includes(
                                                                url
                                                            ),
                                                        })}
                                                    >
